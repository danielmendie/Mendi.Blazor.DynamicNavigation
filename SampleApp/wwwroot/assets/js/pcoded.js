var flg = "0";
{
    ...
    function bind_link() {
        for (var m = document.querySelectorAll(".pc-navbar > li > a"), r = 0; r < m.length; r++)
            m[r].addEventListener("click", function (e) {
                e.preventDefault();
                rm_menu();
            });
        for (var d = document.querySelectorAll(".pc-user-links > div > a"), r = 0; r < d.length; r++)
            d[r].addEventListener("click", function (e) {
                e.preventDefault();
                rm_menu();
            });
    }
...
function setLayout() {
    ...
    main_layout_change(t),
        ...
        document.body.appendChild(e)) : "color-header" === t ? document.querySelector(".pc-sidebar .m-header .logo-lg") && document.querySelector(".pc-sidebar .m-header .logo-lg").setAttribute("src", "../assets/images/lima_darkground_logo.svg") : "compact" === t ? (e.src = "../assets/js/layout-compact.js",
...
function rm_menu() {
    document.querySelector(".pc-sidebar") && document.querySelector(".pc-sidebar").classList.remove("mob-sidebar-active"),
        ...
        document.querySelector(".pc-sidebar .pc-menu-overlay") && document.querySelector(".pc-sidebar .pc-menu-overlay").remove(),
...
function binder_menu(dotNetObjRef) {
        bind_menu();
        menu_click();
}

function check_menu_visibility(dotNetObjRef) {
    setTimeout(() => {
        const isMenuVisible = document.querySelector('.pc-menu-overlay') !== null;
        dotNetObjRef.invokeMethodAsync("OnMenuVisibilityChanged", isMenuVisible);
    }, 100); // Allow DOM changes to take effect
}

document.addEventListener("DOMContentLoaded", menu_click),
    document.addEventListener("DOMContentLoaded", bind_menu),
...
for (tc = document.querySelectorAll(".auth-main.v2 .img-brand"),
    t = 0; t < tc.length; t++)
    tc[t].setAttribute("src", "../assets/images/lima_darkground_logo.svg");
var rtl_flag = !1
    , dark_flag = !1;


document.addEventListener("DOMContentLoaded", function () {
    "undefined" != typeof Storage && layout_change_default();/*layout_change(localStorage.getItem("theme"))*/
    var t = localStorage.getItem("preset");
    if (null !== t) {
        preset_change(t);
    }
    else {
...
function layout_change(e) {
    ...
    t && t.classList.remove("active"),
        "dark" == e ? (dark_flag = !0,
        document.querySelector(".pc-sidebar .m-header .logo-lg") && document.querySelector(".pc-sidebar .m-header .logo-lg").setAttribute("src", "../assets/images/lima_darkground_logo.svg"),
        document.querySelector(".navbar-brand .logo-lg") && document.querySelector(".navbar-brand .logo-lg").setAttribute("src", "../assets/images/lima_darkground_logo.svg"),
        document.querySelector(".auth-wrapper.v3 .auth-header") && document.querySelector(".auth-wrapper.v3 .auth-header img").setAttribute("src", "../assets/images/lima_darkground_logo.svg"),
        document.querySelector(".auth-main.v1 .auth-sidefooter") && document.querySelector(".auth-main.v1 .auth-sidefooter img").setAttribute("src", "../assets/images/lima_darkground_logo.svg"),
        document.querySelector(".footer-top .footer-logo") && document.querySelector(".footer-top .footer-logo").setAttribute("src", "../assets/images/lima_darkground_logo.svg"),
            ...
            document.querySelector(".pc-sidebar .m-header .logo-lg") && document.querySelector(".pc-sidebar .m-header .logo-lg").setAttribute("src", "../assets/images/lima_lightground_logo.svg"),
            document.querySelector(".navbar-brand .logo-lg") && document.querySelector(".navbar-brand .logo-lg").setAttribute("src", "../assets/images/lima_lightground_logo.svg"),
            document.querySelector(".auth-wrapper.v3 .auth-header") && document.querySelector(".auth-wrapper.v3 .auth-header img").setAttribute("src", "../assets/images/lima_lightground_logo.svg"),
                    document.querySelector(".auth-main.v1 .auth-sidefooter") && document.querySelector(".auth-main.v1 .auth-sidefooter img").setAttribute("src", "../assets/images/lima_lightground_logo.svg"),
            document.querySelector(".footer-top .footer-logo") && document.querySelector(".footer-top .footer-logo").setAttribute("src", "../assets/images/lima_lightground_logo.svg"),
                    document.querySelector(".theme-layout .btn.active") && (document.querySelector(".theme-layout .btn.active").classList.remove("active"),
