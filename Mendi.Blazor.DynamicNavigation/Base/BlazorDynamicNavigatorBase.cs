...
{
    public abstract class BlazorDynamicNavigatorBase : ComponentBase
    {
        ...
        [Inject] protected ILogger<BlazorDynamicNavigatorBase> Logger { get; set; } = default!;
        [Inject] protected NavigationState NavigationState { get; set; } = default!;
        [Inject] protected NavigatorSettings Setting { get; set; } = default!;
        /// <summary>
        ...
        protected virtual Task OnBeforeNavigateAsync(RoutePageInfo route, Dictionary<string, string>? parameters) => Task.CompletedTask;
        /// <summary>
        ...
        /// <returns>A <see cref="Task"/> that represents the asynchronous operation. The default implementation returns a
        /// completed task.</returns>
        protected virtual Task OnAfterNavigateAsync(RoutePageInfo route, Dictionary<string, string>? parameters) => Task.CompletedTask;
        /// <summary>
