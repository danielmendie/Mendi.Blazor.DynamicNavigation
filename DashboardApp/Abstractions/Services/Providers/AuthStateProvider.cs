...
namespace DashboardApp.Abstractions.Services.Providers
{
    public class AuthStateProvider : AuthenticationStateProvider, IAccessTokenProvider
    {
        ...
        {
            var authData = await _localStorage.GetItemAsync<AuthUserData>(ConfigType.IdentityUserStore);
            ...
            //if user hs setup account - log them in using mock authentication
        ...
        public ValueTask<AccessTokenResult> RequestAccessToken()
        {
            ...
            InteractiveRequestOptions interaction = new() { Interaction = InteractionType.GetToken, ReturnUrl = "/", Scopes = new string[] { "api", "openid", "profile", "offline_access" } };
