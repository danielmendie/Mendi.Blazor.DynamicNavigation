...
namespace PageFlow.Blazor.Services.Helpers
{
...
#pragma warning disable CS8602 // Dereference of a possibly null reference.
        ...
        private async Task WaitForReference(CancellationToken token = default)
        {
            ...
            {
                _accessorJsRef = new(await _jsRuntime.InvokeAsync<IJSObjectReference>("import", cancellationToken: token, "./_content/PageFlow.Blazor/NavigatorAccessor.js"));
            }
        }
